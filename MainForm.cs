...
namespace YOACOMClientCSharp
{
    public partial class MainForm : Form, IYuantaAPIEvents
    {
        ...
        // testdb 선택
        public static MongoDatabase stockdb = cli.GetServer().GetDatabase("test");
        // 컬렉션 선택
        static string today = DateTime.Now.ToString("yyMMdd");

        public static MongoCollection collection = stockdb.GetCollection<BsonDocument>(today+"_kosdaq");
