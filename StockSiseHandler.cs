...
// 300001 국내주식 현재가 
        private void Process300001_Auto11(bool bAuto)
        {
            ...
            //추가
            m_mainForm.LogMessage("\n종목명 : " + m_iYuantaAPI.YOA_GetFieldString("jongname", 0));
            
            int nColor = m_iYuantaAPI.YOA_GetFieldAttr("curjuka", 0);
            //추가
            //string strnColor = nColor.ToString();
            ...
            //추가
            m_mainForm.LogMessage("\n현재가 : " + m_mainForm.Commify(m_iYuantaAPI.YOA_GetFieldLong("curjuka", 0)));
            ...
            if (bAuto)
            {
                ...
                //추가
                m_mainForm.LogMessage("\n체결량 : " + m_iYuantaAPI.YOA_GetFieldString("nowvol", 0));
                m_mainForm.LogMessage("-----------------------------------------------------------------");
            ...
            else
            {
                ...
                //추가
                m_mainForm.LogMessage("\n전일종가 : " + m_iYuantaAPI.YOA_GetFieldLong("prevlastjuka", 0));
                m_mainForm.LogMessage("-----------------------------------------------------------------");
...
// 데이터 수신 관련 메소드
        ...
        // strAutoID = 실시간TR id값 (11 - 실시간현재가, 12 - 실시간호가)
